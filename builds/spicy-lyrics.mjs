...
// Define our URLs
const BucketURL = "https://storage.spicy-lyrics.spikerko.org/spicy-lyrics";
const LatestVersionURL = "https://version.spicy-lyrics.spikerko.org/"; // OLD URL: https://api.spicy-lyrics.spikerko.org/version
