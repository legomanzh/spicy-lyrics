type LoggerMessage = string | number | boolean | null | undefined | Array<string | number | boolean | null | undefined>;
type ProcessedLoggerMessage = Array<string | number | boolean | null | undefined>;

const Logger = {
  log: (messages: LoggerMessage) => {
    const processedMessages: ProcessedLoggerMessage = typeof messages === "object" ? messages : [messages];
